...
- Slurm runbook: `docs/superpowers/plans/2026-04-06-jepa-slurm-autonomous-execution.md` (Task 0).
- Bridge implementation: `scripts/smolvla_vggflow/bridge_builder.py`.
